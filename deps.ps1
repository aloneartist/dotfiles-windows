...
$chocolatey_root_path = "c:\lib\choco";
### Chocolatey
if ((which cinst) -eq $null) {
    if ( !(Test-Path $chocolatey_root_path) )
    {
        New-Item $chocolatey_root_path -ItemType directory
    }
    $env:ChocolateyInstall = $chocolatey_root_path;
